...
export const CATALOG: Record<ItemId, CatalogItem> = {
  ...
  // --- Doors --------------------------------------------------------------
  door_open_close: { id: "door_open_close", name: "Door Open/Close Sensor", category: "Doors", requiresWifi: false },
  door_shock: { id: "door_shock", name: "Door Shock Sensor", category: "Doors", requiresWifi: false },
  overhead_garage_sensor: { id: "overhead_garage_sensor", name: "Overhead Garage Door Sensor", category: "Doors", requiresWifi: false },

  // --- Windows ------------------------------------------------------------
  window_open_close: { id: "window_open_close", name: "Window Open/Close Sensor", category: "Windows", requiresWifi: false },
  window_shock: { id: "window_shock", name: "Window Shock Sensor", category: "Windows", requiresWifi: false },
  glass_break: { id: "glass_break", name: "Glass Break Detector", category: "Windows", requiresWifi: false },
  motion_sensor: { id: "motion_sensor", name: "Motion Sensor", category: "Windows", requiresWifi: false },
